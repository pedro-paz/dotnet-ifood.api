...
namespace deep.ifood.api.Infrastructure.Migrations
{
    ...
    [Migration("20210227221036_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("deep.ifood.api.Domain.Entities.Cliente", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("deep.ifood.api.Domain.Entities.Empresa", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("deep.ifood.api.Domain.Entities.Ingrediente", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("deep.ifood.api.Domain.Entities.Pedido", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("deep.ifood.api.Domain.Entities.PedidoProduto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("deep.ifood.api.Domain.Entities.Produto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("deep.ifood.api.Domain.Entities.Usuario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("deep.ifood.api.Domain.Entities.Ingrediente", b =>
                {
                    b.HasOne("deep.ifood.api.Domain.Entities.Empresa", "Empresa")
                        .WithMany()
                        .HasForeignKey("IdEmpresa")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("deep.ifood.api.Domain.Entities.Produto", "Produto")
            ...
            modelBuilder.Entity("deep.ifood.api.Domain.Entities.Pedido", b =>
                {
                    b.HasOne("deep.ifood.api.Domain.Entities.Cliente", "Cliente")
                        .WithMany()
            ...
            modelBuilder.Entity("deep.ifood.api.Domain.Entities.PedidoProduto", b =>
                {
                    b.HasOne("deep.ifood.api.Domain.Entities.Pedido", "Pedido")
